...
public class Login1 extends javax.swing.JFrame {
     ...
     public void showTime() {
        Timer timer = new Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                jButton3.setText(currentTimeDate.toString());
            }
        });
        timer.start();
    }
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtten, javax.swing.GroupLayout.PREFERRED_SIZE, 329, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        txtaccount.setBackground(new java.awt.Color(255, 153, 0));
        txtaccount.setFont(new java.awt.Font("Segoe UI Emoji", 1, 12)); // NOI18N
        txtaccount.setText("Click here create a new account!!!");
        txtaccount.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                txtaccountMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                txtaccountMouseEntered(evt);
            }
        });
    ...
    if (username.equals("") || password.equals("") || password.equals("")) {
        JOptionPane.showConfirmDialog(rootPane, "Some fields are empty", "Error", 1);
    } else {
        try {
            java.sql.Connection con = JDBCConnection.getConnection();
            String sql = "SELECT * FROM customers WHERE TK = ? AND MK = ?";
            ...
            if (resultSet.next()) {
                ...
                if (password.equalsIgnoreCase("Admin") && dbRole.equalsIgnoreCase("Role_Admin")) {
                    JOptionPane.showMessageDialog(null, "Login successfully");
                    new ManagerForm().setVisible(true);
                    this.dispose();
                } else if (password.equalsIgnoreCase("User") && dbRole.equalsIgnoreCase("Role_User")) {
                    JOptionPane.showMessageDialog(null, "Login successfully");
                    new MenuForm().setVisible(true);
                    this.dispose();
                } else {
                    JOptionPane.showConfirmDialog(rootPane, "Role not matched", "Login Error", 1);
                }
            } else {
                JOptionPane.showConfirmDialog(rootPane, "Username or password not matched", "Login Error", 1);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void txtaccountMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtaccountMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_txtaccountMouseEntered
