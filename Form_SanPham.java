...
public class Form_SanPham extends javax.swing.JFrame {
    ...
    public Form_SanPham() {
        ...
        mol1 = (DefaultTableModel) tb_spct.getModel();
    ...
    void fillTable(ArrayList<Model_sanpham> list) {
        ...
        for (Model_sanpham x : list) {
            mol.addRow(new Object[]{i++, x.getMasp(), x.getThuonghieu(), x.getTenSP(), x.getNgaytao(), x.getMaDanhMuc(), x.getNgaychinhsua(), x.getNguoichinhsua(), x.getSoLuong()});
        }
    }

    void fillTableSPCT(ArrayList<Model_SPCT> list) {
        int i = 1;
        mol1.setRowCount(0);
        for (Model_SPCT x : list) {
            mol1.addRow(new Object[]{i++, x.getMaKM(), x.getMaSPCT(), x.getTenSP(), x.getMoTa(), x.getGia(), x.getSoLuong(), x.getHinhthucthanhtoan()});
        }
    }
    ...
    private void initComponents() {
        ...
        tbl_sp.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã sản phẩm", "Thương hiệu", "Tên SP", "Ngày tạo", "Người chỉnh sửa", "Số lượng", "Ngày chỉnh sửa"
            }
        ));
        ...
        tb_spct.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã San Pha,", "Mã Khuyen Mai", "Tên sản phẩm", "Mô tả", "Giá bán", "Số lượng", "Hình thức thanh toán"
            }
        ));
    ...
    private void tbl_spMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_spMouseClicked
        ...
        if (i >= 0) {
            show(i);
            Model_sanpham sp = rp.getAll().get(i);
            ArrayList<Model_SPCT> list = rp.getSPCT(sp.getMasp());
            fillTableSPCT(list);
        }
